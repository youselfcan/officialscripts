...
SpellLib = {
    ...
    Ekko = {
        ...
        R = {
            ...
            Delay               = function() return 0.5 end,
            Dmg                 = function() return ({150, 300, 450})[SpellLevel(SpellSlot.R)] end,
            DmgModAD            = function(self, Target) return Target.AbilityPower * 1.5 end,
            DamageType          = DamageType.PHYSICALDAMAGE,
            SpellSlot           = SpellSlot.R,
        },
    },
    ...
    Hecarim = {
        ...
        Q = {
            ...
            DmgModAD            = function(self, Target) return Target.BonusAttack * 0.95 end,
            DamageType          = DamageType.PHYSICALDAMAGE,
            SpellSlot           = SpellSlot.Q,
        },
        W = {
    ...
    Maokai = {
        ...
        E = {
            ...
            DmgModAP            = function(self, Target) return Target.AbilityPower * 0.425 end,
    ...
    MasterYi = {
        ...
        E = {
            ...
            DmgModAP            = function(self, Target) return Target.BonusAttack * 0.35 end,
            DamageType          = DamageType.TRUEDAMAGE,
            SpellSlot           = SpellSlot.E,
        },
        R = {
    ...
    Shyvana = {
        ...
        E = {
            ...
            Delay               = function() return 0.25 end,
            Dmg                 = function(self, Target) return ({60, 100, 140, 180, 220})[SpellLevel(SpellSlot.E)] end,
            DmgModAD            = function(self, Target) return (Target.BaseAttack + Target.BonusAttack) * 0.3 end,
            DmgModAP            = function(self, Target) return Target.AbilityPower * 0.7 end,
            DamageType          = DamageType.MAGICALDAMAGE,
            SpellSlot           = SpellSlot.E,
        },
        E2 = {
            ...
            Dmg                 = function(self, Target) return ({0,0,0,0,0,100, 105, 110, 115, 120, 125, 130, 135, 140, 145, 150, 155, 160})[HeroLvl()] + ({60, 100, 140, 180, 220})[SpellLevel(SpellSlot.E)] end,
            DmgModAD            = function(self, Target) return (Target.BaseAttack + Target.BonusAttack) * 0.6 end,
            DmgModAP            = function(self, Target) return Target.AbilityPower * 1 end,
            DamageType          = DamageType.MAGICALDAMAGE,
            SpellSlot           = SpellSlot.E,
    ...
    TahmKench = {
        ...
        Q = {
            Range               = function() return 900 end,
            Delay               = function() return 0.25 end,
            Dmg                 = function(self, Target) return ({80, 130, 180, 230, 280})[SpellLevel(SpellSlot.Q)] + (Target.AbilityPower * 0.7) end,
    ...
    MonkeyKing = {
        ...
        R = {
            ...
            DmgModAD            = function(self, Target) return (Target.BaseAttack + Target.BonusAttack) * 4.4 end,
            DamageType          = DamageType.PHYSICALDAMAGE,
            SpellSlot           = SpellSlot.R,
        },
    },
